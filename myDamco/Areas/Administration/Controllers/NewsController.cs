...
namespace myDamco.Areas.Administration.Controllers
{
    public class NewsController : BaseAdminController
    {
        ...
        public JsonResult UpdateNewsItem(NewsItem item)
        {
            ...
            if (!Roles.GetRolesForUser(profile.UserName).Contains(reqRole)) throw new UnauthorizedAccessException("Current user and/or role lacks authorization to do this");
