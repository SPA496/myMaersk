...
namespace myDamco.Controllers
{
    ...
    public class ServicesController : Controller
    {
        ...
        public JsonResult ELearning(string widgetUID, bool waitForNonCached)
        {
            ...
            {
                //commenting if condition code to work E Learning widget.

                //if (UAMUtils.UAMHasOperation(conf.UAMApplication, conf.UAMFunction, Roles.GetRolesForUser()) && (conf.roles == null || conf.roles.Any(
                //        role =>
                //        {
        ...
        private RssFeed GetDamcoNewsLocalFeed(int categoryId, int limit)
        {
            ...
            if (category != null)
            {
                ...
                //{
                //    sw.WriteLine("_______________Service controller__________________________");
                //    sw.WriteLine("GetProfile.Name: " + myDamco.Profile.GetProfile().UserName.ToString());
                //    sw.WriteLine("_______________Service controllere end__________________________");
                //}
